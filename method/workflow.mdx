...
<Steps>
  <Step title="Describe">
    Hand the agent the issue, written per [Issues](/method/issues). The agent runs `/speckit.specify` and returns `spec.md` for your review. Every scenario binds to one test by its id (like `CAP-001`).
...
| Name | Description |
| --- | --- |
| Capture | The agent files a Linear issue the moment work is identified, structured per [Issues](/method/issues) |
